...
export async function POST(request: Request) {
  try {
    ...
    // Create a specialized prompt template for follow-up questions
    const promptTemplate = PromptTemplate.fromTemplate(`
      You are an expert educational tutor specializing in explaining complex concepts in clear, accessible ways.
      Your goal is to help the student understand by providing detailed, step-by-step explanations to their questions.
      ...
      When answering:
      1. Be clear and thorough in your explanations
      2. Use examples when helpful
      3. Break down complex concepts into simpler parts
      4. Reference previous parts of the conversation if relevant
