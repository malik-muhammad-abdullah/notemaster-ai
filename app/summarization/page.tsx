            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
              <div className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Upload a document to get an AI-generated summary. This tool
                  can handle PDF, Word, PowerPoint and text files to create
                  concise summaries.
                </p>
                ...
                <form onSubmit={handleUpload}>
                  ...
                  {file && (
                    <div className="flex items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg mt-4">
                  ...
                  <button
                    ...
                    className={`mt-6 w-full py-4 px-4 rounded-xl text-white font-medium shadow-lg transform transition-all duration-200 ${
                      !file || uploading
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 h-full">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <p className="text-gray-700 dark:text-gray-300">
                      AI extracts and analyzes the content
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <p className="text-gray-700 dark:text-gray-300">
                      Receive a concise, accurate summary
                    </p>
                  </div>
                </li>
              </ul>
